# DATA-001 — Exclude archived clients from normal reads
...
Exclude archived clients from normal reads. Archive changes normal visibility; it does not grant a user a way around access control or erase historical evidence.

## 2. Current behavior and evidence

clients has softDelete/restore, but ordinary reads do not consistently predicate deletedAt:null.

The baseline below is source inspection, not production verification. Read these exact files before editing:

- [Backend/src/modules/clients/clients.service.ts](https://github.com/anmolsansi/Property-OS/blob/06ce222654fbaed7bfda33802a89c305574f0e95/Backend/src/modules/clients/clients.service.ts) — exists at the baseline commit.
- [Backend/src/modules/clients/clients.controller.ts](https://github.com/anmolsansi/Property-OS/blob/06ce222654fbaed7bfda33802a89c305574f0e95/Backend/src/modules/clients/clients.controller.ts) — exists at the baseline commit.
- [Backend/src/modules/clients/**tests**/clients.service.spec.ts](https://github.com/anmolsansi/Property-OS/blob/06ce222654fbaed7bfda33802a89c305574f0e95/Backend/src/modules/clients/__tests__/clients.service.spec.ts) — exists at the baseline commit.
...
| File                                                            | Baseline state                    |
| --------------------------------------------------------------- | --------------------------------- |
| `Backend/src/modules/clients/clients.service.ts`                | Existing — inspect before editing |
| `Backend/src/modules/clients/clients.controller.ts`             | Existing — inspect before editing |
| `Backend/src/modules/clients/__tests__/clients.service.spec.ts` | Existing — inspect before editing |
...
**Depends On:** [TEN-003](../Pending/TEN-003-enforce-tenant-access-throughout-clients.md)
...
**Where:** `Backend/src/modules/clients/clients.service.ts`
...
**Where:** `Backend/src/modules/clients/clients.controller.ts`
...
**Purpose:** Prove the boundary named “Archive survives reload” for exclude archived clients from normal reads.
...
**Purpose:** Prove the boundary named “Restore remains scoped” for exclude archived clients from normal reads.
...
**Purpose:** Prove the boundary named “Repeat lifecycle is stable” for exclude archived clients from normal reads.
...
npm --prefix Backend test -- --runInBand --runTestsByPath src/modules/clients/__tests__/clients.service.spec.ts
```
