# DEC-003 — Select AI providers budgets and processing regions

**Status:** Pending  
**Readiness:** Ready for architect review work  
**Type:** Decision  
**Priority:** P1  
**Area:** Architecture decisions  
**Assessment:** A01, A04, A05, A11  
...
Select AI providers budgets and processing regions. Deciding a safe operating contract is work. The output is a signed decision record; writing this ticket does not grant approval or implement a feature.
...
| `docs/new-features/decisions/ai-provider-budget.md` | Proposed — create here or consume dependency-created file |
...
**Blocks:** [MEDIA-002](../Pending/MEDIA-002-verify-actual-uploaded-bytes-before-completion.md), [OPS-001](../Pending/OPS-001-make-background-processing-capability-explicit.md), [AI-001](../Pending/AI-001-create-private-source-job-and-review-persistence.md), [AI-002](../Pending/AI-002-add-a-schema-constrained-provider-adapter.md), [AI-010](../Pending/AI-010-extract-brochure-fields-with-page-level-evidence.md), [AI-013](../Pending/AI-013-transcribe-consented-voice-notes-into-editable-drafts.md), [DEC-009](../Pending/DEC-009-choose-paid-pilot-entitlement-and-billing-policy.md), [AI-026](../Pending/AI-026-evaluate-floor-plan-extraction-on-a-bounded-test-set.md)
...
- Compare at least two providers against permissioned fixtures; record current official documentation/pricing date
- Name exact model/API version, timeout, request and monthly cost ceilings
- Approve processor terms, region and retention with the responsible owner
- Name OCR/transcription choices and reject unsupported file types
- Record credentials only by secret variable name, never value
...
**Where:** `docs/new-features/decisions/ai-provider-budget.md`

**Change:** Write the proposed decision: One reviewed structured-generation provider adapter and separate OCR/transcription adapters; no runtime automatic provider switching. Disable outbound AI until model ID, region, allowed data and hard spend limits are approved.
...
**Change:** Run the decision review against: Compare at least two providers against permissioned fixtures; record current official documentation/pricing date; Name exact model/API version, timeout, request and monthly cost ceilings; Approve processor terms, region and retention with the responsible owner; Name OCR/transcription choices and reject unsupported file types; Record credentials only by secret variable name, never value
...
**Purpose:** Prove the boundary named “Evidence is traceable” for select ai providers budgets and processing regions.
...
**Purpose:** Prove the boundary named “Decision covers failure and recovery” for select ai providers budgets and processing regions.
...
**Purpose:** Prove the boundary named “No premature activation” for select ai providers budgets and processing regions.
