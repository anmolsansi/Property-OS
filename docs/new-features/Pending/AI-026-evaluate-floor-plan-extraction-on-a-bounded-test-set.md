# AI-026 — Evaluate floor plan extraction on a bounded test set
...
Evaluate floor plan extraction on a bounded test set. Deciding a safe operating contract is work. The output is a signed decision record; writing this ticket does not grant approval or implement a feature.
...
| `docs/new-features/decisions/floorplan-experiment.md` | Proposed — create here or consume dependency-created file |
...
**Depends On:** [AI-023](../Pending/AI-023-suggest-photo-categories-and-quality-issues.md), [DEC-003](../Pending/DEC-003-select-ai-providers-budgets-and-processing-regions.md)
...
- Record per-field accuracy and abstention on illegible/missing-scale plans
- Include rotated, multi-floor and inconsistent-unit examples
- No property writes, verification updates or customer commitments
- Architect decides whether evidence justifies separate production feature tickets
...
**Where:** `docs/new-features/decisions/floorplan-experiment.md`

**Change:** Write the proposed decision: Use20 permissioned/synthetic plans across scan quality/languages; extract draft room labels and printed dimensions with bounding boxes. Do not derive legal/rentable area from assumed scale or publish master unit dimensions. Cap cost using DEC-003 and keep artifacts private.
...
**Change:** Run the decision review against: Record per-field accuracy and abstention on illegible/missing-scale plans; Include rotated, multi-floor and inconsistent-unit examples; No property writes, verification updates or customer commitments; Architect decides whether evidence justifies separate production feature tickets
...
**Purpose:** Prove the boundary named “Evidence is traceable” for evaluate floor plan extraction on a bounded test set.
...
**Purpose:** Prove the boundary named “Decision covers failure and recovery” for evaluate floor plan extraction on a bounded test set.
...
**Purpose:** Prove the boundary named “No premature activation” for evaluate floor plan extraction on a bounded test set.
