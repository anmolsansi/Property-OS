# DEC-005 — Approve sharing retention and customer data use
...
Approve sharing retention and customer data use. Deciding a safe operating contract is work. The output is a signed decision record; writing this ticket does not grant approval or implement a feature.
...
- [Backend/src/modules/proposals/constants/proposal-export-fields.ts](https://github.com/anmolsansi/Property-OS/blob/06ce222654fbaed7bfda33802a89c305574f0e95/Backend/src/modules/proposals/constants/proposal-export-fields.ts) — exists at the baseline commit.
...
| `Backend/src/modules/proposals/constants/proposal-export-fields.ts` | Existing — inspect before editing                         |
| `docs/new-features/decisions/data-disclosure-retention.md`          | Proposed — create here or consume dependency-created file |
...
**Blocks:** [MEDIA-003](../Pending/MEDIA-003-serve-private-media-with-short-lived-authorized-urls.md), [INV-001](../Pending/INV-001-store-per-field-inventory-verification-evidence.md), [AI-001](../Pending/AI-001-create-private-source-job-and-review-persistence.md), [PROP-005](../Pending/PROP-005-persist-immutable-releases-artifact-jobs-and-share-grants.md), [PROP-010](../Pending/PROP-010-issue-revoke-and-read-scoped-client-share-links.md), [AI-013](../Pending/AI-013-transcribe-consented-voice-notes-into-editable-drafts.md), [DEC-006](../Pending/DEC-006-approve-offline-data-and-synchronization-boundaries.md), [SAAS-004](../Pending/SAAS-004-export-tenant-data-and-execute-account-closure-safely.md), [SHARE-002](../Pending/SHARE-002-design-cross-organization-broker-owner-exchange-contracts.md)
...
- Approve permitted public fields and media; classify internal notes and contacts
- Approve source, transcript, lease, audit and backup retention separately
- Decide whether bearer links are acceptable or recipient authentication is required
- Name deletion/hold authority and evidence requirements
- Record regional requirements without inventing legal compliance claims
...
**Where:** `docs/new-features/decisions/data-disclosure-retention.md`

**Change:** Write the proposed decision: Private tenant sources; explicitly released proposal fields only; 7-day maximum bearer grants; proposed 30-day source retention with hold exceptions. No customer-data model training by default.
...
**Change:** Run the decision review against: Approve permitted public fields and media; classify internal notes and contacts; Approve source, transcript, lease, audit and backup retention separately; Decide whether bearer links are acceptable or recipient authentication is required; Name deletion/hold authority and evidence requirements; Record regional requirements without inventing legal compliance claims
...
**Purpose:** Prove the boundary named “Evidence is traceable” for approve sharing retention and customer data use.
...
**Purpose:** Prove the boundary named “Decision covers failure and recovery” for approve sharing retention and customer data use.
...
**Purpose:** Prove the boundary named “No premature activation” for approve sharing retention and customer data use.
