# AI-025 — Run a rules baseline for deal prioritization
...
Run a rules baseline for deal prioritization. Deciding a safe operating contract is work. The output is a signed decision record; writing this ticket does not grant approval or implement a feature.
...
| `docs/new-features/decisions/deal-priority-experiment.md` | Proposed — create here or consume dependency-created file |
...
**Depends On:** [CRM-001](../Pending/CRM-001-capture-explicit-lost-deal-and-rejected-property-reasons.md), [METRIC-001](../Pending/METRIC-001-measure-the-intake-to-visit-funnel-without-private-payloads.md), [DEC-001](../Pending/DEC-001-approve-the-first-pilot-and-measurement-baseline.md)
...
- Separate historical observation from prospective experiment
- Specify cohort, labels, time split, missing-label rate and measurement owner
- Report precision/actionability by team without fabricated ROI
- Stop if label reliability insufficient; predictive implementation remains unapproved
...
**Where:** `docs/new-features/decisions/deal-priority-experiment.md`

**Change:** Write the proposed decision: Evaluate explainable overdue-next-action and stale-deal rules first using approved CRM outcomes. No predictive score, automatic lead exclusion or protected/sensitive trait inference. Compare measured action completion against baseline before proposing a model.
...
**Change:** Run the decision review against: Separate historical observation from prospective experiment; Specify cohort, labels, time split, missing-label rate and measurement owner; Report precision/actionability by team without fabricated ROI; Stop if label reliability insufficient; predictive implementation remains unapproved
...
**Purpose:** Prove the boundary named “Evidence is traceable” for run a rules baseline for deal prioritization.
...
**Purpose:** Prove the boundary named “Decision covers failure and recovery” for run a rules baseline for deal prioritization.
...
**Purpose:** Prove the boundary named “No premature activation” for run a rules baseline for deal prioritization.
