# DEC-004 — Approve legacy money conversion and rounding
...
Approve legacy money conversion and rounding. Deciding a safe operating contract is work. The output is a signed decision record; writing this ticket does not grant approval or implement a feature.
...
- [Backend/src/modules/units/dto/units.schema.ts](https://github.com/anmolsansi/Property-OS/blob/06ce222654fbaed7bfda33802a89c305574f0e95/Backend/src/modules/units/dto/units.schema.ts) — exists at the baseline commit.
...
| `Backend/src/modules/units/dto/units.schema.ts`  | Existing — inspect before editing                         |
| `docs/new-features/decisions/money-migration.md` | Proposed — create here or consume dependency-created file |
...
**Blocks:** [DATA-007](../Pending/DATA-007-migrate-financial-values-through-shadow-decimal-columns.md), [REQ-001](../Pending/REQ-001-persist-a-versioned-commercial-requirement-brief.md), [COST-001](../Pending/COST-001-calculate-occupancy-cost-from-exact-known-components.md), [DEC-008](../Pending/DEC-008-choose-lease-offer-approval-and-accounting-boundaries.md)
...
- List every amount/rate field including Unit, Requirement, Deal, Commission and Invoice
- Decide historical currency and treatment of values outside supported precision
- Approve rounding and reconciliation tolerances with the business owner
- Define shadow-read/dual-write window and rollback without destructive float recreation
...
**Where:** `docs/new-features/decisions/money-migration.md`

**Change:** Write the proposed decision: Use MONEY-v1 for new contracts; backfill legacy floats into shadow decimals after field-by-field reconciliation. Preserve old API compatibility until consumers migrate.
...
**Change:** Run the decision review against: List every amount/rate field including Unit, Requirement, Deal, Commission and Invoice; Decide historical currency and treatment of values outside supported precision; Approve rounding and reconciliation tolerances with the business owner; Define shadow-read/dual-write window and rollback without destructive float recreation
...
**Purpose:** Prove the boundary named “Evidence is traceable” for approve legacy money conversion and rounding.
...
**Purpose:** Prove the boundary named “Decision covers failure and recovery” for approve legacy money conversion and rounding.
...
**Purpose:** Prove the boundary named “No premature activation” for approve legacy money conversion and rounding.
