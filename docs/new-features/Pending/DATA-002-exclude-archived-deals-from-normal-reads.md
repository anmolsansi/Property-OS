# DATA-002 — Exclude archived deals from normal reads
...
Exclude archived deals from normal reads. Archive changes normal visibility; it does not grant a user a way around access control or erase historical evidence.

## 2. Current behavior and evidence

deals has softDelete/restore, but ordinary reads do not consistently predicate deletedAt:null.
...
**Depends On:** [TEN-007](../Pending/TEN-007-enforce-tenant-access-throughout-deals.md)

**Blocks:** [CRM-001](../Pending/CRM-001-capture-explicit-lost-deal-and-rejected-property-reasons.md)
...
**Purpose:** Prove the boundary named “Archive survives reload” for exclude archived deals from normal reads.
...
**Purpose:** Prove the boundary named “Restore remains scoped” for exclude archived deals from normal reads.
...
**Purpose:** Prove the boundary named “Repeat lifecycle is stable” for exclude archived deals from normal reads.
