# DEC-007 — Approve owner roles and asset grant policy
...
**Assessment:** P15, P16, P17, P22, P27  
...
Approve owner roles and asset grant policy. Deciding a safe operating contract is work. The output is a signed decision record; writing this ticket does not grant approval or implement a feature.
...
| `docs/new-features/decisions/owner-asset-policy.md`  | Proposed — create here or consume dependency-created file |
...
**Blocks:** [LEASE-001](../Pending/LEASE-001-create-the-lease-register-and-immutable-term-versions.md), [OWNER-001](../Pending/OWNER-001-enforce-explicit-same-tenant-asset-capability-grants.md), [DEC-008](../Pending/DEC-008-choose-lease-offer-approval-and-accounting-boundaries.md)
...
- Owner/asset-manager/leasing-user/invited-broker action matrix signed
- No grant permits another tenant’s client/contact/commission access
- Lease activation approver and self-approval policy explicit
- Revocation must affect queued jobs and portal reads immediately
...
**Where:** `docs/new-features/decisions/owner-asset-policy.md`

**Change:** Write the proposed decision: Add explicit same-organization AssetGrant capabilities view_availability, propose_availability, view_lease, review_lease, activate_lease. Grants never turn an ordinary app role into global ADMIN. Owner pilot starts with same-organization named users; cross-organization exchange is SHARE-002.
...
**Change:** Run the decision review against: Owner/asset-manager/leasing-user/invited-broker action matrix signed; No grant permits another tenant’s client/contact/commission access; Lease activation approver and self-approval policy explicit; Revocation must affect queued jobs and portal reads immediately
...
**Purpose:** Prove the boundary named “Evidence is traceable” for approve owner roles and asset grant policy.
...
**Purpose:** Prove the boundary named “Decision covers failure and recovery” for approve owner roles and asset grant policy.
...
**Purpose:** Prove the boundary named “No premature activation” for approve owner roles and asset grant policy.
