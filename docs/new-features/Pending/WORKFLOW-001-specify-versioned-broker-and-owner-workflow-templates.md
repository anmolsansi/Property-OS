# WORKFLOW-001 — Specify versioned broker and owner workflow templates
...
Specify versioned broker and owner workflow templates. Deciding a safe operating contract is work. The output is a signed decision record; writing this ticket does not grant approval or implement a feature.
...
| `docs/new-features/decisions/workflow-templates.md` | Proposed — create here or consume dependency-created file |
...
**Depends On:** [CRM-002](../Pending/CRM-002-record-authorized-interaction-history-and-corrections.md), [LEASE-003](../Pending/LEASE-003-generate-and-complete-reviewed-lease-obligations.md), [OPS-004](../Pending/OPS-004-persist-notification-outcomes-and-replay-controls.md)
...
- Model one broker followup and one lease-review workflow as fixtures
- Define idempotency, retry, cancel and version migration behavior
- Every action calls existing domain policy and entitlement checks
- Implementation split into schema, interpreter and editor after signed template examples
...
**Where:** `docs/new-features/decisions/workflow-templates.md`

**Change:** Write the proposed decision: Use declarative versioned templates with allowlisted trigger, event predicate, task action and assignee strategy. No arbitrary JavaScript, SQL or customer code forks. Existing in-flight workflows pin a version; template edits affect new runs only.
...
**Change:** Run the decision review against: Model one broker followup and one lease-review workflow as fixtures; Define idempotency, retry, cancel and version migration behavior; Every action calls existing domain policy and entitlement checks; Implementation split into schema, interpreter and editor after signed template examples
...
**Purpose:** Prove the boundary named “Evidence is traceable” for specify versioned broker and owner workflow templates.
...
**Purpose:** Prove the boundary named “Decision covers failure and recovery” for specify versioned broker and owner workflow templates.
...
**Purpose:** Prove the boundary named “No premature activation” for specify versioned broker and owner workflow templates.
