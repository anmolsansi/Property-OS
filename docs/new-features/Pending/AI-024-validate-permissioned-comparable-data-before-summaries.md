# AI-024 — Validate permissioned comparable data before summaries
...
Validate permissioned comparable data before summaries. Deciding a safe operating contract is work. The output is a signed decision record; writing this ticket does not grant approval or implement a feature.
...
| `docs/new-features/decisions/comparables-pilot.md` | Proposed — create here or consume dependency-created file |
...
**Depends On:** [DATA-009](../Pending/DATA-009-normalize-free-text-locations-with-reviewed-mappings.md), [COST-001](../Pending/COST-001-calculate-occupancy-cost-from-exact-known-components.md), [REPORT-001](../Pending/REPORT-001-compute-allowlisted-portfolio-reports.md)
...
- Permission and provenance for at least30 representative records documented
- Missing basis/stale sample exclusions shown in deterministic worksheet
- Summary fixture separates listing from completed transaction prices
- Implementation tickets require source schema and ingestion contract approval
...
**Where:** `docs/new-features/decisions/comparables-pilot.md`

**Change:** Write the proposed decision: Use only customer-authorized comparable records with transaction/listing distinction, asOf date, area/rent basis, currency and provenance. Code computes sample ranges and exclusions; AI summarizes selected facts. Do not scrape licensed market databases or label asking rents as achieved rents.
...
**Change:** Run the decision review against: Permission and provenance for at least30 representative records documented; Missing basis/stale sample exclusions shown in deterministic worksheet; Summary fixture separates listing from completed transaction prices; Implementation tickets require source schema and ingestion contract approval
...
**Purpose:** Prove the boundary named “Evidence is traceable” for validate permissioned comparable data before summaries.
...
**Purpose:** Prove the boundary named “Decision covers failure and recovery” for validate permissioned comparable data before summaries.
...
**Purpose:** Prove the boundary named “No premature activation” for validate permissioned comparable data before summaries.
