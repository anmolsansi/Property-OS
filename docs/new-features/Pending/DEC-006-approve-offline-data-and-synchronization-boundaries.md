# DEC-006 — Approve offline data and synchronization boundaries
...
Approve offline data and synchronization boundaries. Deciding a safe operating contract is work. The output is a signed decision record; writing this ticket does not grant approval or implement a feature.
...
| `docs/new-features/decisions/offline-synchronization.md` | Proposed — create here or consume dependency-created file |
...
**Depends On:** [TEN-001](../Pending/TEN-001-create-an-explicit-server-derived-access-context.md), [DEC-005](../Pending/DEC-005-approve-sharing-retention-and-customer-data-use.md)
...
- Demonstrate logout/expiry purge without deleting canonical records
- Define shared-device prohibition and supported browser storage failure behavior
- Specify create request identity and update409 merge UI before implementation
...
**Where:** `docs/new-features/decisions/offline-synchronization.md`

**Change:** Write the proposed decision: Pilot allows local text drafts only, partitioned by account, with explicit device consent and7-day expiry. No leases, private media, bearer tokens or automatic background writes. Synchronization uses server version compare; conflicts require field review.
...
**Change:** Run the decision review against: Demonstrate logout/expiry purge without deleting canonical records; Define shared-device prohibition and supported browser storage failure behavior; Specify create request identity and update409 merge UI before implementation
...
**Purpose:** Prove the boundary named “Evidence is traceable” for approve offline data and synchronization boundaries.
...
**Purpose:** Prove the boundary named “Decision covers failure and recovery” for approve offline data and synchronization boundaries.
...
**Purpose:** Prove the boundary named “No premature activation” for approve offline data and synchronization boundaries.
