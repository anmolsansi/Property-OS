# DEC-001 — Approve the first pilot and measurement baseline
...
Approve the first pilot and measurement baseline. Deciding a safe operating contract is work. The output is a signed decision record; writing this ticket does not grant approval or implement a feature.
...
| `docs/new-features/decisions/pilot-scope.md`         | Proposed — create here or consume dependency-created file |
...
**Blocks:** [REQ-001](../Pending/REQ-001-persist-a-versioned-commercial-requirement-brief.md), [DEC-009](../Pending/DEC-009-choose-paid-pilot-entitlement-and-billing-policy.md), [PRODUCT-001](../Pending/PRODUCT-001-guide-onboarding-to-the-first-useful-shortlist.md), [METRIC-001](../Pending/METRIC-001-measure-the-intake-to-visit-funnel-without-private-payloads.md), [AI-025](../Pending/AI-025-run-a-rules-baseline-for-deal-prioritization.md)
...
- Name city, asset type, pilot owner, 3-5 trial teams and permitted data source
- Measure requirement-to-reviewed-proposal time before automation
- Ratify 30% time reduction and zero critical access failures as continuation gates
- Define who verifies inventory and who supports failures
...
**Where:** `docs/MARKET_AI_ASSESSMENT.md`
...
**Where:** `docs/new-features/decisions/pilot-scope.md`

**Change:** Write the proposed decision: Internal commercial office leasing first; one named city and team selected by the product owner; external brokerage trial next; owner trials start with availability and reviewed leases.
...
**Change:** Run the decision review against: Name city, asset type, pilot owner, 3-5 trial teams and permitted data source; Measure requirement-to-reviewed-proposal time before automation; Ratify 30% time reduction and zero critical access failures as continuation gates; Define who verifies inventory and who supports failures
...
**Purpose:** Prove the boundary named “Evidence is traceable” for approve the first pilot and measurement baseline.
...
**Purpose:** Prove the boundary named “Decision covers failure and recovery” for approve the first pilot and measurement baseline.
...
**Purpose:** Prove the boundary named “No premature activation” for approve the first pilot and measurement baseline.
